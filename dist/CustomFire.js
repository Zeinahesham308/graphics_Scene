...
var vs = [
  ...
  var initMaterial =  ( function () {
    ...
    return function () {
      ...
      console.log("path is ", VolumetricFire.texturePath, " image is ", nzw)
  ...
  var VolumetricFire = function ( width, height, depth, sliceSpacing, camera ) {
    ...
    var fireGeometry = new THREE.BufferGeometry();
    fireGeometry.dynamic = true;
    fireGeometry.setIndex( new THREE.BufferAttribute( index, 1 ) );
    fireGeometry.setAttribute( 'position', new THREE.BufferAttribute( position, 3 ) );
    fireGeometry.setAttribute( 'tex',      new THREE.BufferAttribute( tex,      3 ) );
    //console.log("Attrib is ", fireGeometry.getAttribute("tex"))
